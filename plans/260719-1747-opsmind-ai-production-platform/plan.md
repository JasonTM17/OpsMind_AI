...
| 4 | [Incident Control Plane and Audit Ledger](./phase-04-incident-control-plane-and-audit-ledger.md) ([4B evidence ingress](./phase-04b-bounded-evidence-record-ingress.md)) | In Progress — 4A complete; 4B implemented locally, live DB CI pending |
