...
final class InvestigationWorkflowStartLeaseRowMapper implements RowMapper<OutboxLease> {

    static final InvestigationWorkflowStartLeaseRowMapper INSTANCE =
        new InvestigationWorkflowStartLeaseRowMapper();

    private InvestigationWorkflowStartLeaseRowMapper() {
    }
