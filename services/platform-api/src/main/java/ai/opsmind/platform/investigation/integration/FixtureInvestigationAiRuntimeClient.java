    ...
    public AnalysisRuntimeResponse analyze(InvestigationAnalysisRequest request) {
        if (request.evidenceIds().isEmpty()) {
            ...
            return new AnalysisRuntimeResponse(
                "need_more_evidence", request.runId(), "fixture-analysis", "prompt-incident-investigation-v1",
        ...
        UUID evidenceId = request.evidenceIds().stream().sorted().findFirst()
        ...
        return new AnalysisRuntimeResponse(
            "complete", request.runId(), "fixture-analysis", "prompt-incident-investigation-v1", "analysis-v1",
