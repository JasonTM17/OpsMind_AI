...
Disagreement about a technical decision is not a conduct problem, and this
document is not a tool for ending one. Evidence, reproduction, and measurement
settle technical questions here; seniority and volume do not. Saying that a claim
is unsupported is fair. Saying that a person is unserious is not.
...
through the private channel documented in [`SECURITY.md`](SECURITY.md). All
