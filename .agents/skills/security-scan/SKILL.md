...
Lightweight security scanner using Codex's reasoning + shell tools. No external dependencies required.
...
| Code patterns | Grep + Codex analysis | Medium | `references/vulnerability-patterns.md` |
...
- Use Codex reasoning to determine if it's a real vulnerability or false positive
