...
cd .Codex/skills/markdown-novel-viewer
npm install
```
...
node .Codex/skills/markdown-novel-viewer/scripts/server.cjs \
...
node .Codex/skills/markdown-novel-viewer/scripts/server.cjs --stop
```
...
node .Codex/skills/markdown-novel-viewer/scripts/server.cjs --file ./README.md --host 0.0.0.0 --port 3456
```
