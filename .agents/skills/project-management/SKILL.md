...
description: "Track progress, update plan statuses, manage Codex Tasks, generate reports, coordinate docs updates. Use for project oversight, status checks, plan completion, task hydration, cross-session continuity."
user-invocable: true
...
Project oversight and coordination using Codex native Tasks with persistent plan files.
...
- Hydrating/syncing Codex Tasks with plan files
