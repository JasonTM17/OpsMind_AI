...
```bash
python .Codex/skills/copywriting/scripts/extract-writing-styles.py --list        # List files
python .Codex/skills/copywriting/scripts/extract-writing-styles.py --style <name> # Extract style
```
