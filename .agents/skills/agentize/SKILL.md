...
- **Companion skill** — a `/ck:*` skill discoverable on the Codex Plugins Marketplace
...
4. **Companion skill** — invoke `/ck:skill-creator` to generate:
   - Skill at `Codex/skills/<tool-name>/SKILL.md` with:
...
- `docs/` complete
- Green CI
- Skill staged at `Codex/skills/<tool-name>/`
...
Agentization ready.
  ...
  • Skill:   Codex/skills/<tool-name>/  (publish to marketplace: see docs/skill.md)
