...
description: Create or update Codex skills with eval-driven iteration. Use for new skills, skill scripts, references, benchmark optimization, description optimization, eval testing, extending Codex's capabilities.
user-invocable: true
when_to_use: "Invoke when creating or refining Codex skills."
category: dev-tools
...
Create effective, eval-driven Codex skills using progressive disclosure and human-in-the-loop iteration.

## Core Principles

- Skills are **practical instructions**, not documentation
- Each skill teaches Codex *how* to perform tasks, not *what* tools are
...
New skills **MUST** be created in CWD: `./.Codex/skills/` (**NOT** `~/.Codex/skills/` unless requested)
...
- [Agent Skills Docs](https://docs.Codex.com/en/docs/Codex/skills.md)
- [Best Practices](https://docs.Codex.com/en/docs/agents-and-tools/agent-skills/best-practices.md)
- [Plugin Marketplaces](https://code.Codex.com/docs/en/plugin-marketplaces.md)
