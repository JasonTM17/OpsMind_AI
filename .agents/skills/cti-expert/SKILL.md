...
Cyber threat intelligence and open-source intelligence skill. Turns Codex into a trained CTI/OSINT analyst. Generates precision search queries, interprets public data, builds case timelines, and delivers structured intelligence products — no API keys, no paid subscriptions.
...
python3 ~/.Codex/skills/cti-expert/scripts/generate-cti-docx-hybrid.py \
...
python3 ~/.Codex/skills/cti-expert/scripts/generate-cti-docx.py \
  "CTI-REPORT-[CASE-ID]-[YYYY-MM-DD].json" \
  "CTI-REPORT-[CASE-ID]-[YYYY-MM-DD].docx"
