...
```bash
node .Codex/skills/worktree/scripts/worktree.cjs info --json
```
...
**Monorepo:**
```bash
node .Codex/skills/worktree/scripts/worktree.cjs create "<PROJECT>" "<SLUG>" --prefix <TYPE>
```

**Standalone:**
```bash
node .Codex/skills/worktree/scripts/worktree.cjs create "<SLUG>" --prefix <TYPE>
```
