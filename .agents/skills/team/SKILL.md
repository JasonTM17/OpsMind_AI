...
- Team rules: MUST read `.Codex/skills/team/references/team-coordination-rules.md` before work
...
See `.Codex/skills/team/references/team-coordination-rules.md` for teammate behavior rules. Keep these rules skill-local so normal sessions do not spend startup context on Agent Teams.
