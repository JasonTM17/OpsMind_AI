...
foreach ($name in @(
    ...
    'OPERATOR_WEB_PORT', 'PLATFORM_API_PORT', 'PLATFORM_MANAGEMENT_PORT',
    'OPSMIND_MANAGEMENT_EXPOSED_ENDPOINTS', 'OPSMIND_MAX_JSON_BODY_BYTES',
    ...
    'AI_PROVIDER_PROBE_MAX_CALLS_PER_HOUR',
    ...
    'OPSMIND_TOOL_CAPABILITY_MAX_LIFETIME',
    'OPSMIND_TOOL_GATEWAY_CLIENT_ENABLED', 'OPSMIND_TOOL_GATEWAY_ENDPOINT',
    'OPSMIND_TOOL_GATEWAY_ALLOW_LOCAL_CLEARTEXT',
    'OPSMIND_TOOL_GATEWAY_CONNECT_TIMEOUT', 'OPSMIND_TOOL_GATEWAY_REQUEST_TIMEOUT',
    'OPSMIND_TOOL_GATEWAY_MAX_RESPONSE_BODY_BYTES',
    'OPSMIND_TOOL_WORKLOAD_AUTH_ENABLED', 'OPSMIND_TOOL_WORKLOAD_ISSUER',
    'OPSMIND_TOOL_WORKLOAD_TOKEN_ENDPOINT',
    'OPSMIND_TOOL_WORKLOAD_ALLOW_LOCAL_CLEARTEXT',
    'OPSMIND_TOOL_WORKLOAD_AUDIENCE', 'OPSMIND_TOOL_WORKLOAD_CLIENT_ID',
    'OPSMIND_TOOL_WORKLOAD_SCOPE', 'OPSMIND_TOOL_WORKLOAD_CONNECT_TIMEOUT',
    'OPSMIND_TOOL_WORKLOAD_REQUEST_TIMEOUT', 'OPSMIND_TOOL_WORKLOAD_REFRESH_SKEW',
    'OPSMIND_TOOL_WORKLOAD_MAX_TOKEN_LIFETIME',
    ...
    'OPSMIND_DISPATCHER_ENABLED', 'OPSMIND_DISPATCHER_DB_URL',
    'OPSMIND_DISPATCHER_DB_USERNAME', 'OPSMIND_DISPATCHER_DB_POOL_MAX',
    'OPSMIND_DISPATCHER_DB_CONNECTION_TIMEOUT_MS',
    'OPSMIND_WORKFLOW_RECONCILER_ENABLED',
    ...
    'OPSMIND_INVESTIGATION_TEMPORAL_CLIENT_ENABLED',
    ...
    'OPSMIND_INVESTIGATION_TEMPORAL_CLIENT_REQUIRED_WORKER_POLLER_MAX_AGE',
    'OPSMIND_INVESTIGATION_TEMPORAL_CLIENT_REQUIRED_WORKER_POLLER_FUTURE_SKEW',
    ...
    'OPSMIND_INVESTIGATION_TEMPORAL_OBSERVER_TARGET',
    'OPSMIND_INVESTIGATION_TEMPORAL_OBSERVER_TLS_ENABLED',
    'OPSMIND_INVESTIGATION_TEMPORAL_OBSERVER_ALLOW_LOCAL_CLEARTEXT',
    'OPSMIND_INVESTIGATION_TEMPORAL_OBSERVER_RPC_TIMEOUT',
    'OPSMIND_WORKFLOW_RECONCILER_POLL_INTERVAL',
    'OPSMIND_WORKFLOW_RECONCILER_LEASE_DURATION',
    'OPSMIND_WORKFLOW_RECONCILER_SETTLEMENT_MARGIN',
    'OPSMIND_WORKFLOW_RECONCILER_MAX_ATTEMPTS',
    'OPSMIND_WORKFLOW_RECONCILER_MAX_AGE',
    'OPSMIND_WORKFLOW_RECONCILER_MAX_HANDOFF_AGE',
    'OPSMIND_WORKFLOW_RECONCILER_INITIAL_BACKOFF',
    'OPSMIND_WORKFLOW_RECONCILER_MAX_BACKOFF',
    'OPSMIND_WORKFLOW_RECONCILER_ABSENCE_CONFIRMATION_DELAY',
    'OPSMIND_WORKFLOW_RECONCILER_NAMESPACE_RETENTION',
    'OPSMIND_WORKFLOW_RECONCILER_RETENTION_SAFETY_MARGIN',
    'OPSMIND_INVESTIGATION_WORKFLOW_STARTER_ENABLED',
    'OPSMIND_INVESTIGATION_WORKFLOW_STARTER_POLL_INTERVAL',
    'OPSMIND_INVESTIGATION_WORKFLOW_STARTER_LEASE_DURATION',
    'OPSMIND_INVESTIGATION_WORKFLOW_STARTER_RPC_MARGIN',
    'OPSMIND_INVESTIGATION_WORKFLOW_STARTER_MAX_AGE',
    'OPSMIND_INVESTIGATION_WORKFLOW_STARTER_INITIAL_BACKOFF',
    'OPSMIND_INVESTIGATION_WORKFLOW_STARTER_MAX_BACKOFF',
    'OPSMIND_INVESTIGATION_WORKFLOW_STARTER_MAX_ATTEMPTS',
    'OPSMIND_INVESTIGATION_WORKFLOW_STARTER_TENANT_LIMIT',
    'OPSMIND_INVESTIGATION_WORKFLOW_STARTER_BATCH_SIZE',
    'OPSMIND_WORKFLOW_RECONCILER_DB_URL',
    'OPSMIND_WORKFLOW_RECONCILER_DB_USERNAME',
    'OPSMIND_WORKFLOW_RECONCILER_DB_POOL_MAX',
    'OPSMIND_WORKFLOW_RECONCILER_DB_CONNECTION_TIMEOUT_MS',
...
$runtimeSecretNames = @(
    ...
    'OPSMIND_TOOL_WORKLOAD_CLIENT_SECRET', 'OPSMIND_DISPATCHER_DB_PASSWORD',
