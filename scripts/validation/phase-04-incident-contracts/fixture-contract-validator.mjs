...
export const fixtureCases = [
  ...
  ["patch-incident-request.update.valid.json", "incidents/patch-incident-request.schema.json", true],
  ["patch-incident-request.assign-owner.valid.json", "incidents/patch-incident-request.schema.json", true],
  ["patch-incident-request.clear-owner.valid.json", "incidents/patch-incident-request.schema.json", true],
  ["patch-incident-request.empty.invalid.json", "incidents/patch-incident-request.schema.json", false],
  ["patch-incident-request.authority-field.invalid.json", "incidents/patch-incident-request.schema.json", false],
  ["patch-incident-request.owner.invalid.json", "incidents/patch-incident-request.schema.json", false],
  ["transition-incident-request.resolved.valid.json", "incidents/transition-incident-request.schema.json", true],
  ["transition-incident-request.closed.valid.json", "incidents/transition-incident-request.schema.json", true],
  ...
  ["incident.closed.valid.json", "incidents/incident.schema.json", true],
