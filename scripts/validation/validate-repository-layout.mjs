...
const expectedFiles = [
  ...
  "scripts/validation/cross-service/prove-evaluation-export-scope.sql",
  "scripts/validation/cross-service/register-evaluation-export-scope.sql",
  "evaluation/runner/project-cross-service-evaluation-export.mjs",
  "evaluation/schemas/cross-service-evaluation-export.schema.json",
  "evaluation/schemas/held-out-manifest.schema.json",
  "evaluation/schemas/normalized-analysis.schema.json",
  ...
  "evaluation/runner/human-baseline.mjs",
